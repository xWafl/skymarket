  ...
  data() {
    return {
      buttons: [
        ...
        // timespan of one month: current time - current time (1 month subtracted)
        { id: 3, color: COLOR_UNCLICKED_BUTTON, text: "1 Month", isClicked = false, timespan = (new Date().getTime() - new Date().setMonth(new Date().getMonth()-1).getTime())},
